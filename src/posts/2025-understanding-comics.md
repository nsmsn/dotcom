...
<figcaption>
<details>
  <summary>Accessible description of page 58</summary>
  <p>Large panel: Scott swims though a sea of abstacted icons. "By drawing <strong>borders</strong> around the vocabulary of comics, I hope I haven't made it seem smaller than it is. Comics artists have a <strong>universe</strong> of icons to choose from! And it's expanding all the time! Society is inventing <strong>new</strong> symbols regularly, just as comics artists do."</p>
  
  <p>A smaller panel shows a human head full of recognizable symbols and logos, like the no smoking sign, the olympics icon, and the Toyota vehicle logo. "Ours is an increasingly symbol-oriented culture."</p>
  
  <p>Scott's cartoon face on a universal walking person figure: "As the <strong>twenty-first century</strong> approaches, visual iconography may finally help us realize a form of <strong>universal communictaion</strong>."</p>
</details>
</figcaption>
</figure>
...
<figure role="group">
<img src="/img/post-images/2025-understanding-comics-page-151.jpg" loading="lazy" alt="a comics page about every new medium being compared to what came before, and being misunderstood. Described in more detail below." width="800" height="1210">
<figcaption>
<details>
  <summary>Accessible description of page 151</summary>
  <p>Panel 1: A boy in a word balloon shirt tosses a ball in the background. Scott says: "The art form of comics is many centuries old, but it's perceived as a recent invention and suffers the curse of all new media."</p>

  <p>Panel 2: bald bearded figures in robes representing literature, theatre, painting surround the little comics boy. Scott: "The curse of being judged by the standards of the old."</p>
  
  <p>Panel 3: Ever since the invention of the written word, new media have been misunderstood. A prehistoric man says to another man carving into a tablet: "Careful Jacob! If you keep doing this, you'll stop using your memory!"</p>
  
  <p>Panel 4: Each new medium begins its life by imitating its predecessors. Many early movies were like filmed stage plays, much early television was like radio with pictures or reduced movies.</p>

  <p>Panel 5: Scott has several pedestals representing art forms behind him, with two sequential comics panels on a lower pedestal than the others. "Far too many comics creators have no higher goal than to match the achievements of other media, and view any chance to work in othe rmedia as a step up."</p>
  
  <p>Panel 6: And again, as long as we view comics as a genre of writing or a style of graphic art this attitude may never disappear.</p>
</details>
</figcaption>
</figure>
...
I also think about how rapidly visual communication has evolved in the Internet Age, in the thirty years since we got an <code>img</code> tag added to HTML. This year's backlash to the Cracker Barrel logo redesign may have been manufactured, but it builds upon a recent history of people using the web and social media to react, remix and dunk on corporate redesigns (The Gap and the University of California rebrands were earlier, more organic examples). A whole book could be written on memes, which are often visual (and increasingly audiovisual) and encourage a user-generated remixing. Today someone without drawing skills can even prompt an AI program like ChatGPT to create a set of comic panels for them, drawn in either a soulless generic style or one that apes a recognizable artist's hand like Bill Watterson's or Hayao Miyazaki's.
